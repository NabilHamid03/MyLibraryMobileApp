...
👉 **[Télécharger l'APK depuis la dernière release](https://github.com/NabilHamid03/MyLibraryMobileApp/releases/tag/release)**

Installer l' `.apk` sur un appareil Android (activer *Sources inconnues* dans les paramètres si nécessaire).

## Captures d'écran

| Connexion | Bibliothèque | Détails du livre |
|---|---|---|
| ![Écran de connexion](screenshots/loginscreen.jpg) | ![Écran bibliothèque](screenshots/library_screen.jpg) | ![Détails du livre](screenshots/details_screen.jpg) |
